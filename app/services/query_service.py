import uuid
from ..core import llm_client, settings, vector_db_client
...
class QueryService:
    ...
    def retrieve_similarities(self) -> Dict[str, Any]:
        """
        ...
        return self.query_embeddings(embeddings=embeddings)
    ...
    def query_embeddings(self, embeddings: List[float]) -> Dict[str, Any]:
        """
        ...
        """
        try:
            results = vector_db_client.search_similar(embeddings)
